...
<<<<<<< HEAD
      ...
      <div className="field">
        ...
        <div className="control">
          <input className="input" defaultValue={user.lastName} name="lastName" type="text" placeholder="Write your last name" />
        </div>
      </div>
      ...
      <div className="field">
        ...
        <div className="control">
          <input className="input" defaultValue={user.location} name="location"  type="text"  placeholder="Enter your location"/>
          </div>
      </div>
      ...
      <div className="field">
        ...
        <div className="control">
        <input className="input" defaultValue={user.aboutMe} name="aboutMe"  type="text"  placeholder="Tell us about yourself"/>
        </div>
      </div>
